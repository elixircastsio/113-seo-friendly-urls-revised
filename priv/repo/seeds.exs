...
movie_attrs = [
  ...
  %{
    ...
    summary:
      "Don Lockwood is a popular silent film star with humble roots as a singer, dancer and stunt man. Don barely tolerates his vapid, shallow leading lady, Lina Lamont, who has convinced herself that the fake romance their studio concocted and publicized is real.",
    year: "1952"
  },
  %{
    title: "It's A Wonderful Life",
    summary:
      "On the Christmas Eve of Bedford Falls, the guardian angel Clarence is assigned to convince the desperate George Bailey not to commit suicide. George is a good man that sacrificed his dreams and his youth on behalf of the citizens of his small town.",
    year: "1946"
  },
  %{
    title: "Sunset BLVD",
    summary:
      "While trying to escape from his creditors, he has a flat tire and parks his car in a decadent mansion in Sunset Boulevard. He meets the owner and former silent-movie star Norma Desmond, who lives alone wit her butler and driver Max von Mayerling.",
    year: "1950"
  }
]

Enum.each(movie_attrs, fn attrs ->
  Film.create_movie(attrs)
end)
